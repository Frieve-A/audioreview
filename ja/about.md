...
lang: ja
permalink: /ja/about/
legacy_tagline: "物語に耳を貸さず、ブランドに目を眩まさず。静寂の中で向き合うオーディオの真価。"
legacy_description: "世界中の数十のソースを網羅的に調査して導く、まさしく最終結論とも呼べるレビューを多数掲載するオーディオ関連企業・製品のメタレビューサイトです。科学的・論理的・合理的視点から、測定による音質と機能だけを基準に、主観・好み・ロマン・デザイン等の視点を徹底排除し、一切の忖度なく淡々とレビューします。"
---
