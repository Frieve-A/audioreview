...
<div class="page-header">
  <div class="page-title-section">
    <h1 class="page-title-with-search">製品一覧 <span class="search-icon">🔍</span> <span class="review-count" id="result-count">Loading...</span></h1>
  </div>
...
<div class="rating-filter-section" id="rating-filter-section">
  <!-- Rating filter will be dynamically generated by JavaScript -->
</div>

<!-- Price filter section -->
<div class="price-filter-section" id="price-filter-section">
  <!-- Price filter will be dynamically generated by JavaScript -->
</div>
