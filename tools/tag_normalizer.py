...
normalization_rules_ja = {
    ...
    # Additional normalizations based on analysis
    ...
    'DSP': 'DSP',
    'Dynamic Driver': 'ダイナミックドライバー',
    'Planar Magnetic': 'プラナーマグネティック',
    'Balanced Armature': 'バランスドアーマチュア',
    'Room Correction': 'ルームコレクション',
    'Class D': 'クラスD',
    ...
    'DTM': 'DTM',
    'Recording': '録音',
    'Desktop Audio': 'デスクトップオーディオ',
    'Budget-friendly': 'コストパフォーマンス',
    'Studio': 'スタジオ',
    'Portable audio': 'ポータブルオーディオ',
    'Classic': 'クラシック',
    'Mid-range': 'ミドルレンジ',
    'Entry-Level': 'エントリーレベル',
