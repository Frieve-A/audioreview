...
price: 1017636
summary: "測定重視のSAMサブウーファーで、統合性とサポートは強力です。入手可能な超低域測定は、サブ帯域内での科学的有効性を十分に支えています。"
tags: [Active, SAM, サブウーファー, スタジオモニター, プロフェッショナル]
permalink: /products/ja/genelec-7380a/
---
## 概要
