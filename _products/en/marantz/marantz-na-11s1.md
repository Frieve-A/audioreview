...
The Marantz NA-11S1 is a network audio player and DAC from the Reference Series, released in 2013. It boasts excellent measurement performance with 24bit/192kHz PCM and DSD support, a 110dB S/N ratio, and 0.001% THD+N, designed as a high-end unit for its time. It is currently discontinued and trades on the used market for around 115,000 JPY. As a high-end, Japanese-made product manufactured at Marantz's domestic factory, it was a flagship representing the brand's prestige.
...
Against the used market price of 115,000 JPY, the WiiM Ultra (59,400 JPY) exists with equivalent or superior functionality and measurement performance. The calculation is: 59,400 JPY ÷ 115,000 JPY = 0.52, which rounds to 0.5. Even more affordable alternatives, such as pairing a PC with a high-performance USB DAC like the Topping E30 II Lite (approximately 15,000 JPY), can achieve superior measurement performance at a fraction of the cost. With overwhelmingly cheaper alternatives available for network playback, DAC functionality, and measurement performance, its cost-performance is poor. The rationale for its existence as a dedicated device has been lost in modern times.
